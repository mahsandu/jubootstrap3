  ...
  <div class="container">
    <div class="journals row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
      {foreach from=$journals item=journal}
        {assign var="url" value="{url journal=$journal->getPath()|escape}"}
        ...
        <div class="col mb-4">
          <div class="card h-100">
            ...
            <div class="card-footer d-flex justify-content-end">
              <a class="btn btn-light text-shadow me-2" href="{$url}">
                {translate key="site.journalView"}
              </a>
              <a class="btn btn-light text-shadow" href="{url journal=$journal->getPath() page="issue" op="current"}">
