...
<script>
    // Waypoint animation
    const issueTocSection = document.querySelector('.issue-toc');
    const waypoint = new Waypoint({
        element: issueTocSection,
        handler: function (direction) {
            if (direction === 'down') {
                issueTocSection.classList.add('fadeIn');
            } else {
                issueTocSection.classList.remove('fadeIn');
            }
        },
        offset: '80%'
    });
